...
ready = function(){
  ...
  $(window).resize(function(){
    ...
    // $('.slider-container').height(window.innerHeight());
    window.photoWidth = window.innerWidth();
    $('.slider-nav a.slider-nav-item').trigger('click');
    // trace($('.slider-container').left);
    // trace($('.slider-container').top);
  });
